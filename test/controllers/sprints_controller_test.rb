...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { finished_on: @sprint.finished_on, number: @sprint.number, started_on: @sprint.started_on, team_id: @sprint.team_id }
    end
  ...
  test "should update sprint" do
    patch :update, id: @sprint, sprint: { finished_on: @sprint.finished_on, number: @sprint.number, started_on: @sprint.started_on, team_id: @sprint.team_id }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
